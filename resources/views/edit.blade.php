...
<body>
    ...
    <div class="dflex">
    <div class="content">
        <form action="{{ url('hotel', $hotels->id) }}" method="POST" class="this-form" enctype="multipart/form-data">
            @csrf

            @method("PUT")
            <span>Name</span><br>
            <input type="text" name="name" id="" placeholder="{{$hotels->name}}" value="{{$hotels->name}}">
            <br><br>

            <span>Location</span><br>
            <input type="text" name="location" id="" placeholder="{{$hotels->location}}" value="{{$hotels->location}}">
            <br><br>
            ...
            <input type="number" name="price_per_night" id="" placeholder="{{$hotels->price_per_night}}" value="{{$hotels->price_per_night}}">
            <br><br>
            ...
            <textarea name="synopsis" id="" rows="5" placeholder="{{$hotels->synopsis}}"></textarea>

            <br>
            <button class="btn default">Save changes :D</button>
